                        ...
                        <div class="card-body">
                            ...
                            <div class="table table-responsive">
                                <div style="text-align: right">
                                    <a class="btn btn-primary mb-2" href="add_edit_category-products.php">CREATE</a>
                                </div>
                                <table class="table table-bordered">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-success btn-sm" href="add_edit_category-products.php?idEdit=<?php echo $row['id']; ?>">Edit</a>
                                                <a class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin delete?')" href="category-products.php?idDel=<?php echo $row['id'] ?>">Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
