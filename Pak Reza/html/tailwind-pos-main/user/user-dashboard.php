...
<body>
    ...
    <!-- ======= Header ======= -->
    <?php include '../inc-user/navbar.php' ?>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active"><a href="user-dashboard.php">Dashboard</a></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active"><a href="view-stocks.php">Check all of stock products.</a></li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active"><a href="../index.php">Let's transaction here.</a></li>
                            </ol>
                        </div>
                    </div>
    ...
    <footer id="footer" class="footer">
        <div class="credits">
            ...
            Developed by <a href="user-dashboard.php">Yusuf Niko Fitranto</a>
        </div>
    </footer><!-- End Footer -->
