...
if ($result && mysqli_num_rows($result) > 0) {
  while ($row = mysqli_fetch_assoc($result)) {
    ...
    $products[] = [
      ...
      'image' => 'assets/assets-adm/uploads/products/' . $row['product_photo'],
      'option' => null
    ];
  }
}
...
<head>
  ...
  <link rel="shortcut icon" href="logo-ppkdjp.jpg" type="image/x-icon">
    ...
    <div x-show="isShowModalReceipt"
      ...
      <div x-show="isShowModalReceipt" class="w-96 rounded-3xl bg-white shadow-xl overflow-hidden z-10"
        ...
        <div id="receipt-content" class="text-left w-full text-sm p-6 overflow-auto">
          ...
          <!--Print Struck-->
          <div class="text-center">
            <img src="img/logo-ppkdjp.jpg" alt="Tailwind POS" class="mb-3 w-8 h-8 inline-block" />
            <h2 class="text-xl font-semibold">PPKDJP POS</h2>
