                                ...
                                <table class="table table-bordered">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-sm" href="add_role_users.php?AddRole=<?php echo $row['id'] ?>">Add Role</a>
                                                <a class="btn btn-secondary btn-sm" href="add_edit_users.php?Edit=<?php echo $row['id'] ?>">Edit</a>
